...

{
...

    {
        ...
        return $contratacao->fresh(['qqpItens', 'filial', 'anexos']);
...

    {
        ...
        if ($input->filialId !== null) {

            $attributes['filial_id'] = $input->filialId !== '' ? $input->filialId : null;
